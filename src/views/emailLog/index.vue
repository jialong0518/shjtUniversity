<template>
  <div class="account">
    ...
    <el-col :span="6">
        <div style="display: inline-block;width:30%;">邮箱：</div>
        <el-input style="width: 70%" v-model="searchEmail" @change="getTableData()" autocomplete="off"></el-input>
    </el-col>
    <el-col :span="6">
...
<script>
import { getmailrecordlist } from "@/api/log";
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      getmailrecordlist({"name": this.searchName,
